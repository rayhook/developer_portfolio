...
function Filter() {
  ...
  const [sortby, setSortby] = useState("awardYear");

  const selectSortType = (sortBy: string) => {
    setSortby(sortBy);
  };

  const sorted = [...nobel.nobelPrizes].sort((a, b) => b[sortby] - a[sortby]);
      ...
      <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="">
          ...
          <div className="px-4 py-2 bg-green-400">
            <button
              className="py-4 px-2 mx-2 rounded-md bg-slate-400"
              onClick={() => selectSortType("name")}
            >
              name
            </button>
